...
public class Produits {
	...
	private List<Allergenes> listAllergenes = new ArrayList<>();
	private List<Additifs> listAdditifs = new ArrayList<>();
	...
	public List<Allergenes> getAllergenes() {
		return allergenes;
	public List<Allergenes> getListAllergenes() {
		return listAllergenes;
	}

	public void setAllergenes(List<Allergenes> allergenes) {
		this.allergenes = allergenes;
	public void setListAllergenes(List<Allergenes> listAllergenes) {
		this.listAllergenes = listAllergenes;
	}

	@Override
	public String toString() {
		return "Produits [categorie=" + categorie + ", marque=" + marque + ", grade=" + grade + ", nom=" + nom
				+ ", ingredients=" + ingredients + ", additifs=" + additifs + ", allergenes=" + allergenes + "]";
